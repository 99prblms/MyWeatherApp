...
class MyCustomCellTV: UITableViewCell {
    ...
    var MinlabelView:UILabel = {
        let label = UILabel()
        label.font = UIFont.systemFont(ofSize: 20)
        return label
    }()
    
    var MaxlabelView:UILabel = {
        let label = UILabel()
        label.font = UIFont.systemFont(ofSize: 20)
        return label
    }()
    ...
    var cityLabelViewNamed: UILabel = {
        let label = UILabel()
        label.text = "Город:"
        label.font = UIFont.systemFont(ofSize: 20)
    ...
    private func setupCellCustomView() {
    ...
    private func setupCityLabelViewNamed() {
    ...
    private func setupMinLabelView() {
    ...
    private func setupMaxLabelView() {
